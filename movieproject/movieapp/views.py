...
def add_movie(request):
    ...
    if request.method == 'POST':
        ...
        movie = Movie(name=move_name, slug=slug, poster=poster, description=description, release_date=release_date,
                      actors=actors,
...
def proDetail(request, c_slug, movie_slug):
    ...
    if request.method == 'POST':
        ...
        item_reviews = Review(movie=movie, rating=star_rating, review_desp=item_review)
        item_reviews.save()
